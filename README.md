...
- **LovableSafety (Safety Guard)**: antes de cada ação (seguir, deixar de seguir, curtir), o GrowBot chama `canProceed()`. Se o limite por hora/dia, cooldown ou “calor” diário estiver ativo, a ação é adiada automaticamente.
...
- **Presets (nova / média / madura)**: no popup, escolher o preset aplica limites e delays alinhados ao Safety Guard e ao GrowBot.
