...
const STATUS_CONFIG = {
  online: {
    icon: Wifi,
    pill: "bg-success/6 ring-1 ring-success/15",
    text: "text-success",
    dot: "bg-success",
    ping: true,
    label: "Online",
  ...
  running: {
    icon: Wifi,
    pill: "bg-primary/6 ring-1 ring-primary/15",
    text: "text-primary",
    dot: "bg-primary",
    ping: true,
    label: "Processando",
  ...
  paused: {
    icon: Pause,
    pill: "bg-warning/6 ring-1 ring-warning/15",
    text: "text-warning",
    dot: "bg-warning",
    ping: false,
    label: "Pausado",
  ...
  challenge_required: {
    icon: AlertTriangle,
    pill: "bg-destructive/6 ring-1 ring-destructive/15",
  ...
  offline: {
    icon: WifiOff,
    pill: "bg-muted/6 ring-1 ring-muted/15",
